              ...
              >
                <SidebarMenuItem>
                  <CollapsibleTrigger asChild>
                    <SidebarMenuButton tooltip={item.title} className={`py-5 md:px-3 text-[1.1rem] mb-1 transition-all duration-300 ${pathname === item.url ? 'bg-purple-400 text-white hover:bg-neutral-600 dark:bg-purple-400 dark:text-white hover:bg-purple-400' : 'hover:bg-neutral-200 dark:hover:bg-neutral-50/20'}`}>
                      {item.icon && <item.icon />}
